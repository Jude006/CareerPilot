...
import { Eye, EyeOff, UserPlus, ArrowLeft, Mail, Lock, User, Zap, AlertCircle } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-8 transform hover:shadow-2xl transition-all duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join CareerPilot and start your journey</p>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="text-blue-600 font-medium hover:text-blue-700 transition-colors duration-300">
                Sign in
              </Link>
            </p>
          </div>
